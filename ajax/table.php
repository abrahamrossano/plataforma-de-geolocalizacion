						...
						<table id="datatable_tabletools" class="table table-striped table-bordered table-hover" width="100%">
							<thead>
								<tr>
									...
									<th data-class="expand">Chofer</th>
									<th>Unidad</th>
									<th data-hide="phone">Entrada Geocerca</th>
									<th data-hide="phone,tablet">Salida Geocerca</th>
	             ...
	             "xls",
	                {
	                    "sExtends": "pdf",
	                    "sTitle": "WredGps_PDF",
	                    "sPdfMessage": "w¿Wred Exportar PDF",
	                    "sPdfSize": "letter"
	                },
	             	{
                    	"sExtends": "print",
                    	"sMessage": "Generado por Wred <i>(Presione Esc para salir)</i>"
                	}
	             ],
